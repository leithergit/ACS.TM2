        ...
        static void TestASyncMessage(int count)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    testMessage.Id = 1001;
                    testMessage.Name = "0123456789";
                    testMessage.Data = new byte[buf.Length] ;

                    StructMessage structMessage = new StructMessage();
                    structMessage.Id = 1001;
                    structMessage.Name = "0123456789";
                        //Url = "http://www.google.com",
                        //Site = "google.com",
                    structMessage.Data = new byte[4]; 
                    ...
                    else
                    {
                        try
                        {
                            for (int i = 0; i < count; i++)
                            {
                                ...
                                client.AsyncSend((UInt32)(20 + serializeType), testMessage);
                            }
                        }
                        catch (Exception e)
                        {
